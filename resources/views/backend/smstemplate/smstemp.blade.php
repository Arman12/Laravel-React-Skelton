...
<div class="content-wrapper">
  ...
  <div class="page-header">
    <h4 class="card-title justify-content-center">Sms Templates</h4>
    <a href="{{ route('sms.create') }}" type="submit" class="btn btn-primary">Add Sms Template</a>
  </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="display: flex;">
                  <a class="btn btn-link btn-sm" href="{{ route('sms.edit', ['smsTemplate' => $data])  }}">
                    <i class="mdi mdi-tooltip-edit"></i></a>
                  <form action="{{ route('sms.delete',['smsTemplate' => $data])  }}" method="POST">
                    @csrf
                    @method('DELETE')
